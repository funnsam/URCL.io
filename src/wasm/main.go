...
func main() {
	...
	RegisterToolbarMenuItem(js.Null(), []js.Value{js.ValueOf("Editor"), js.ValueOf("Exclusive to Editor"), js.Global().Get("Stub")})
	RegisterToolbarMenuItem(js.Null(), []js.Value{js.ValueOf("Editor"), js.ValueOf("New Dialog"), js.Global().Get("ShowDialog")})
	RegisterToolbarMenuItem(js.Null(), []js.Value{js.ValueOf("Plugins"), js.ValueOf("Exclusive to Plugins"), js.Global().Get("Stub")})
